...
//         const cartNames = cartArray.map(item => item.name.toLowerCase());
//         return recipes.filter(recipe => {
//             const presentCount = recipe.ingredients.filter(ing =>
//                 cartNames.includes(ing.name.toLowerCase())
//             ).length;
//             return presentCount / recipe.ingredients.length >= 0.5; // 50% or more
//         });
//     }
...
//                     <div className="mt-12">
//                         <h2 className="text-2xl font-medium mb-4">Suggested Recipes</h2>
//                         {suggestedRecipes.map(recipe => (
//                             <div key={recipe.id} className="mb-6 p-4 border border-gray-300 rounded bg-gray-50">
//                                 <h3 className="font-semibold text-lg mb-2">{recipe.name}</h3>
//                                 <p className="font-medium">Ingredients:</p>
//                                 <ul className="list-disc ml-5 mb-2">
//                                     {recipe.ingredients.map((ing, idx) => (
//                                         <li key={idx} className={cartArray.some(item => item.name.toLowerCase() === ing.name.toLowerCase()) ? "text-green-600" : "text-gray-400"}>
